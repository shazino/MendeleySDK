...
// MendeleySDK
#define COCOAPODS_POD_AVAILABLE_MendeleySDK
#define COCOAPODS_VERSION_MAJOR_MendeleySDK 1
#define COCOAPODS_VERSION_MINOR_MendeleySDK 3
#define COCOAPODS_VERSION_PATCH_MendeleySDK 1
